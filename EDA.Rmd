...
**First, we would like to see whether there is any noticable trends in time and the difference between different states. Second, we assumed that fire size and the fire burning duration might have some relationship. What's more, we would like to more which is the most common cause during 10 years.**
