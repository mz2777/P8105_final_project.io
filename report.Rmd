...
## **Discussion**
We recognize that wildfires have various causes and the severity (size, duration...) of wildfires differ by a number of factors; thus, the final model that we present may not be 
